...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG.song.toLowerCase() == 'incident'){ bluefriend = new Boyfriend(770, 450, 'bfblue'); bfG = new Boyfriend(770, 450, 'bfG');}
		if (SONG.song.toLowerCase() == 'rage'){ bfG = new Boyfriend(770, 450, 'bfG'); }
		...
		add(dad);
		if (SONG.song.toLowerCase() == 'rage' || SONG.song.toLowerCase() == 'incident' ){ add(sura2); }
		
		if (SONG.song.toLowerCase() == 'rage' ){ add(bfG); add(rageAnim3); add(faces); }
		add(boyfriend);
		...
		if (SONG.song.toLowerCase() == 'rage') { add(noise); add(glitchs) ;}
		if (SONG.song.toLowerCase() == 'incident' ){ add(bluefriend);  add(sur); add(bfG); add(glitchs); add(sura); }
		if (SONG.song.toLowerCase() == 'redemption' ) {add(sura); add(whito2);};
		...
		if(shakeCam2)
			{
				...
				camHUD.shake(0.01,0.01);
				//camHUD.fade(FlxColor.BLACK, 1, false, null, true); fade
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						switch (Math.abs(daNote.noteData))
						{
							case 2:
								...
								if (SONG.song.toLowerCase() == 'rage')
									{
										trollrager.playAnim('singUP', true);
										trollrager2.playAnim('singUP', true);
										trollrager3.playAnim('singUP', true);
									}
								if (SONG.song.toLowerCase() == 'incident')
									{
									
									bundaTrollgeFinal.playAnim('singUP', true);
									bundaTrollge4.playAnim('singUP', true);
									bundaTrollge3.playAnim('singUP', true);
									bundaTrollge2.playAnim('singUP', true);
									bundaTrollge.playAnim('singUP', true);
									}
								if (SONG.song.toLowerCase() == 'sadness')
									{
										troll2.playAnim('singUP', true);
										troll3.playAnim('singUP', true);
									}
							...
							case 3:
								...
								if (SONG.song.toLowerCase() == 'sadness')
									{
										troll2.playAnim('singRIGHT', true);
										troll3.playAnim('singRIGHT', true);
									}
								if (SONG.song.toLowerCase() == 'rage')
									{
										trollrager.playAnim('singRIGHT', true);
										trollrager2.playAnim('singRIGHT', true);
										trollrager3.playAnim('singRIGHT', true);
									}
								if (SONG.song.toLowerCase() == 'incident')
									{
									bundaTrollgeFinal.playAnim('singRIGHT', true);
									bundaTrollge4.playAnim('singRIGHT', true);
									bundaTrollge3.playAnim('singRIGHT', true);
									bundaTrollge2.playAnim('singRIGHT', true);
									bundaTrollge.playAnim('singRIGHT', true);
									}
							...
							case 1:
								...
								if (SONG.song.toLowerCase() == 'sadness')
									{
										troll2.playAnim('singDOWN', true);
										troll3.playAnim('singDOWN', true);
									}
								if (SONG.song.toLowerCase() == 'rage')
									{
										trollrager.playAnim('singDOWN', true);
										trollrager2.playAnim('singDOWN', true);
										trollrager3.playAnim('singDOWN', true);
									}
								if (SONG.song.toLowerCase() == 'incident')
									{
									bundaTrollgeFinal.playAnim('singDOWN', true);
									bundaTrollge4.playAnim('singDOWN', true);
									bundaTrollge3.playAnim('singDOWN', true);
									bundaTrollge2.playAnim('singDOWN', true);
									bundaTrollge.playAnim('singDOWN', true);
									}
							...
							case 0:
								...
								if (SONG.song.toLowerCase() == 'sadness')
									{
										troll2.playAnim('singLEFT', true);
										troll3.playAnim('singLEFT', true);
									}
								if (SONG.song.toLowerCase() == 'rage')
									{
										trollrager.playAnim('singLEFT', true);
										trollrager2.playAnim('singLEFT', true);
										trollrager3.playAnim('singLEFT', true);
									}
								if (SONG.song.toLowerCase() == 'incident')
									{
									bundaTrollgeFinal.playAnim('singLEFT', true);
									bundaTrollge4.playAnim('singLEFT', true);
									bundaTrollge3.playAnim('singLEFT', true);
									bundaTrollge2.playAnim('singLEFT', true);
									bundaTrollge.playAnim('singLEFT', true);
									}
		...
		if (!boyfriend.stunned)
		{
			...
			switch (direction)
			{
				case 0:
					if (SONG.song.toLowerCase() == 'incident')
						{
							bluefriend.playAnim('singLEFTmiss', true);
							bfG.playAnim('singLEFTmiss', true);
						}
						if (SONG.song.toLowerCase() == 'rage')
						{
							bfG.playAnim('singLEFTmiss', true);
				...
				case 1:
					if (SONG.song.toLowerCase() == 'incident')
						{
							bluefriend.playAnim('singDOWNmiss', true);
							bfG.playAnim('singDOWNmiss', true);
						}
						if (SONG.song.toLowerCase() == 'rage')
						{
							bfG.playAnim('singDOWNmiss', true);
				...
				case 2:
					if (SONG.song.toLowerCase() == 'incident')
						{
							bluefriend.playAnim('singUPmiss', true);
							bfG.playAnim('singUPmiss', true);
						}
					if (SONG.song.toLowerCase() == 'rage')
						{
							bfG.playAnim('singUPmiss', true);
				...
				case 3:
					if (SONG.song.toLowerCase() == 'incident')
						{
							bluefriend.playAnim('singRIGHTmiss', true);
							bfG.playAnim('singRIGHTmiss', true);
						}
						if (SONG.song.toLowerCase() == 'rage')
						{
							bfG.playAnim('singRIGHTmiss', true);
				...
				if (!note.wasGoodHit)
				{
					...
					switch (note.noteData)
					{
						case 2:
							if (SONG.song.toLowerCase() == 'incident')
								{
									bluefriend.playAnim('singUP', true);
									bfG.playAnim('singUP', true);
								}
								if (SONG.song.toLowerCase() == 'rage')
								{
									bfG.playAnim('singUP', true);
						...
						case 3:
							if (SONG.song.toLowerCase() == 'incident')
								{
									bluefriend.playAnim('singRIGHT', true);
									bfG.playAnim('singRIGHT', true);
								}
								if (SONG.song.toLowerCase() == 'rage')
								{
									bfG.playAnim('singRIGHT', true);
						...
						case 1:
							if (SONG.song.toLowerCase() == 'incident')
								{
									bluefriend.playAnim('singDOWN', true);
									bfG.playAnim('singDOWN', true);	
								}
								if (SONG.song.toLowerCase() == 'rage')
								{
									bfG.playAnim('singDOWN', true);	
						...
						case 0:
							if (SONG.song.toLowerCase() == 'incident')
								{
									bluefriend.playAnim('singLEFT', true);
									bfG.playAnim('singLEFT', true);	
								}
								if (SONG.song.toLowerCase() == 'rage')
								{
									bfG.playAnim('singLEFT', true);	
	...
	override function stepHit()
	{
		...
		if (SONG.song == 'Redemption')
		{
			...
			if (curStep == 68)
			{
				...
				thefinalt.playAnim("speak", false);
			}
			if (curStep == 73)
			{
